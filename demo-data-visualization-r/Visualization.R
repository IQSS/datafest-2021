...
US_cases_long_week_spatial %>% 
  ...
  labs(title = "COVID-19 case rates for last week",
       caption = "Data Sources: Harvard Dataverse, 2020;\n U.S. Census Bureau, 2019")
...
#according to the selected attributes. See: https://r-spatial.github.io/mapview/articles/articles/mapview_01-basics.html
